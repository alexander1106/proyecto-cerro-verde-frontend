// reserva-salon-detalle.component.ts
...
@Component({
  selector: 'app-reserva-salon-detalle',
  templateUrl: './reserva-salon-detalle.component.html',
  styleUrls: ['./reserva-salon-detalle.component.css'],
  standalone: false
})
export class ReservaSalonDetalleComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.reservasService.getReservaById(id).subscribe(data => {
      this.reserva = data;
      console.log(this.reserva); // Verifica que salonesXReserva esté presente
    });
  }
